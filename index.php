...
<head>
  <meta charset="utf-8">
  <title>Guilherme Valentine</title>
...
<body id="page-top">
  ...
  <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll" href="#page-top">Guilherme Valentine</a>
      ...
      <div class="navbar-collapse collapse justify-content-end" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll" href="http://devguilhermeoliveira.herokuapp.com/">SiteDev</a>
          </li>
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <h1 class="intro-title mb-4">Guilherme Valentine</h1>
          <p class="intro-subtitle"><span class="text-slider-items">Foco, Força, Fé</span><strong class="text-slider"></strong></p>
            ...
            <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6 col-md-7">
                    <div class="about-info">
                      <p><span class="title-s">Nome: </span> <span>Guilherme Nathaniel</span></p>
                      <p><span class="title-s">Profissão: </span> <span>Designer / Desenvolvedor de sites e sistemas</span></p>
                      <p><span class="title-s">Email: </span> <span>nathanielguilherme8@gmail.com</span></p>
                      <p><span class="title-s">Phone: </span> <span>(67) 98220-5599</span></p>
                    </div>
                  </div>
                </div>
                <div class="skill-mf">
                  <p class="title-s">Responsabilidade</p>
                  <span>Pontualismo</span> <span class="pull-right">100%</span>
                  <div class="progress">
                    <div class="progress-bar" role="progressbar" style="width: 100%" aria-valuenow="90" aria-valuemin="0"
                      aria-valuemax="100"></div>
                  </div>
                  <span>Responsável</span> <span class="pull-right">100%</span>
                  <div class="progress">
                    <div class="progress-bar" role="progressbar" style="width: 100%;" aria-valuenow="85" aria-valuemin="0"
                      aria-valuemax="100"></div>
                  </div>
                  <span>Atendimento</span> <span class="pull-right">100%</span>
                  <div class="progress">
                    <div class="progress-bar" role="progressbar" style="width: 100%" aria-valuenow="75" aria-valuemin="0"
                      aria-valuemax="100"></div>
                  </div>
                  <span>Valores</span> <span class="pull-right">100%</span>
                  <div class="progress">
                    <div class="progress-bar" role="progressbar" style="width: 100%" aria-valuenow="50" aria-valuemin="0"
                      aria-valuemax="100"></div>
                  </div>
                  <span>outros</span> <span class="pull-right">100%</span>
                  <div class="progress">
                    <div class="progress-bar" role="progressbar" style="width: 100%" aria-valuenow="60" aria-valuemin="0"
                      aria-valuemax="100"></div>
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="about-me pt-4 pt-md-0">
                  ...
                  <p class="lead">
                    Olá, Bem vindo em meu site e fico muito feliz que queira fechar negócios comigo,
                    vou falar um pouco sobre o meu trabalho e se houver dúvidas é só me chamar no whatsapp
                    que vai estar ai na sua telinha.
                  </p>
                  <p class="lead">
                    Ai ao lado vai estar um pouco sobre as minhas habilidades e meu desempenho, sou muito dedicado
                    e responsável com os meus trabalhos, logo abaixo você irá ver meu trabalho como designer.
                  </p>
                  <p class="lead">
                    Esse site foi criado apenas para apresentar a você sobre as minhas habilidades como designer e um pouco
                    como desenvolvedor, caso queira alguma coisa voltada a área de desenvolvimento, só entrar em meu outro site que irá 
                    acompanhar quais linguagens tenho entendimento e as que mais trabalho
                  </p>
                </div>
              </div>
            </div>
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="service-box">
            ...
            <div class="service-content">
              <h2 class="s-title">Designer</h2>
              <p class="s-description text-center">
                Trabalho satisfatório e bem complexo para que os meus clientes possa entender
                e não haver dúvidas, pontual em questão de entrega, caso houver algum erro que possa
                atrasar eu comunico antecipadamente.
              </p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="service-box">
            ...
            <div class="service-content">
              <h2 class="s-title">Desenvolvimento de sites</h2>
              <p class="s-description text-center">
                Caso queira contratar algum site incluindo a minha mão de obra de designer, faça um orçamento
                sem compromisso e que não possa te comprometer financeiramente futuramente.
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="service-box">
            ...
            <div class="service-content">
              ...
              <p class="s-description text-center">
                Faço fotográfia de produtos para o trabalho que pedir, porém isso só está disponivel
                na cidade onde eu moro, mas caso queira editar fotos e deixar bem bacana é só me chamar.
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="title-box text-center">
            ...
            <p class="subtitle-a">
              Aqui você irá ver algumas artes que fiz para posts em redes sociais.
            </p>
            <div class="line-mf"></div>
          </div>
        </div>
  ...
  <section id="work" class="portfolio-mf sect-pt4 route">
    <div class="container">
      <div class="row">
        <div class="col-sm-12">
          <div class="title-box text-center">
            ...
            <p class="subtitle-a">
              Essas são algumas manipulações que fiz para estudos...
            </p>
            <div class="line-mf"></div>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="work-box">
            <a href="img/work-8.jpg" data-lightbox="gallery-mf">
              <div class="work-img">
        ...
        <div class="col-md-4">
          <div class="work-box">
            <a href="img/work-9.jpg" data-lightbox="gallery-mf">
              <div class="work-img">
        ...
        <div class="col-md-4">
          <div class="work-box">
            <a href="img/work-10.jpg" data-lightbox="gallery-mf">
              <div class="work-img">
          ...
          <div id="testimonial-mf" class="owl-carousel owl-theme">
            <div class="testimonial-box">
              <div class="author-test">
                ...
                <span class="author">Guilherme Valentine</span>
              </div>
              <div class="content-test">
                <p class="description lead">
                  E ai, o que achou do meu trabalho? Se quiser mais informação é só chamar no whatsapp que está sendo mostrado ai na sua telinha
                  venha fazer o seu orçamento e até!!!
                </p>
